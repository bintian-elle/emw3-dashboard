...
export interface SelectProps<T extends object>
  ...
  /** Classes for the list box (e.g. allow a short menu to show every item). */
  listBoxClassName?: string;
  /** Inline list-box layout overrides for one-off menu sizing. */
        ...
        <>
          ...
          >
            <AriaListBox
              items={items}
              style={listBoxStyle}
              className={cx(MENU_ITEMS_CONTAINER, "max-h-[240px] overflow-auto", listBoxClassName)}
            >
